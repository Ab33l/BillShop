...
.form-group input:focus + label, .form-group input.active + label{
  ...
  <body>
    <div class="login-form" style="margin-top: -247px;">
      <img src="../billsblack.png" alt="BillShop" style="padding-left: 33%;"/>
   ...
   <form action="testing.php" method="POST">
     ...
     <div class="form-group">
       <input type="submit" value="Register" class="btn btn-primary" name="submit" style="height: 50px;color:white;">
     </div>
   </form>
          <p class="text-center" style="text-align: center;">Already Registered  <a href="login.php" style="text-decoration: none;color: white;" class="btn btn-default">Sign In</a></p>
 </div>
  <script>
