...
<!-- Top links -->
        ...
        <div class="limitedOffer">
                <h1 style='text-align:center;font-size:36px;'>25% OFF ALL WEAR*</h1>
                <h2 style='text-align:center;'>+ KSH.99 DELIVERY USE CODE: WIN</h2>
...
<!-- 	<div class="title text-center">
    ...
    <h1 style="color:grey;text-align:center;font-size:30px;padding-top: 20px;">Our featured products</h1>
...
src="https://www.youtube.com/embed/QgGeNfjF-mM?autoplay=0&mute=1&showinfo=0&controls=0" frameborder="0" allowfullscreen>

</iframe> -->
<video class="video-wrapper" autoplay muted>
