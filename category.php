  ...
  <nav>
    <div class="nav-wrapper">
      <ul id="nav-mobile" class="left hide-on-med-and-down">
        <li><a href="sass.html"><i class="small material-icons">search</i></a></li>
      </ul>
      <a href="#" class="brand-logo center">BillShop</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="sass.html"><i class="small material-icons">home</i></a></li>
        <li><a href="badges.html"><i class="small material-icons">shopping_basket</i></a></li>
        <li><a href="collapsible.html"><i class="small material-icons">account_circle</i></a></li>
      </ul>
    </div>
  </nav>
  ...
  <nav>
    <div class="nav-wrapper">
      <ul id="nav-mobile" class="hide-on-med-and-down">
        <li><a href="sass.html">New In</a></li>
        <li><a href="badges.html">Collection</a></li>
        <li><a href="collapsible.html">Tracksuit</a></li>
        <li><a href="collapsible.html">Sale</a></li>
      </ul>
    </div>
  </nav>
